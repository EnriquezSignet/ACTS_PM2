...
<div class="container-fluid">
    <form action="" id="booking-form">
        ...
        <div class="form-group">
            <label for="pickup_zone" class="control-label">Home Address</label>
            <textarea name="pickup_zone" id="pickup_zone" rows="2" class="form-control form-control-sm rounded-0" required></textarea>
        </div>
        <div class="form-group">
            <label for="drop_zone" class="control-label">Notes</label>
            <textarea name="drop_zone" id="drop_zone" rows="2" class="form-control form-control-sm rounded-0" ></textarea>
        </div>
    </form>
</div>
