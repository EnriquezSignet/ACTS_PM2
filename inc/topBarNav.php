...
<head>
    ...
    <title>Access Care with Transparent Services</title>
    <style>
        img#user_avatar {
            width: 2em;
            height: 2em;
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-purple fixed-top" id="topNavBar">
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'contact'? "active" : '' ?>" href="./?p=contact">Contact Us</a></li>
